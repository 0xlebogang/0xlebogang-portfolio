      ...
      <div className="flex w-full items-center justify-center gap-4 px-4 md:grid-cols-2 md:px-6 lg:gap-10">
        <div className="flex w-full items-center justify-center space-y-3 text-left">
          <div className="flex w-full max-w-(--breakpoint-xl) flex-col items-center justify-center">
            <h1 className="text-end text-8xl font-bold tracking-tight md:text-9xl lg:text-[14rem]">
              {hero.name}
            </h1>
            <div className="dark:bg-foreground/10 mb-4 inline-block w-fit rounded-lg bg-gray-100 px-3 py-1 text-sm">
              {hero.label}
            </div>
          </div>
