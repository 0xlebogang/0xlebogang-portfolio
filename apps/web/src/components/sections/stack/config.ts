...
const content: StackContent = {
  ...
  stacks: [
    ...
    },
    {
        ...
        description: "DigitalOcean is the cloud provider I am most competent with. This is where my homelab is hosted. I mainly use their Droplets (VMs) to host the services I find. It has been a fundamental part of my learning journey into cloud, DevOps, Networking and infrastructure management."
    },
    {
        name: "Azure",
        thumbnail: {
        ...
        description: "I have tinkered with MS Azure for just a year, thanks to the GitHub Student Developer Pack. This is where I first started with cloud computing and self-hosting."
    },
    {
        name: "Terraform",
        thumbnail: {
        ...
        description: "Since getting into self-hosting and cloud, Terraform became a tool I sought to learn and has become a big part of how I manage the infrastructure I use in my homelab."
    }
  ],
};
